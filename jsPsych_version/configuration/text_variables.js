...
var page1 = [
  ...
  '<p>However, on some trials (STOP trials) the arrows will turn red after a variable delay. You have to stop your response when this happens. </p>'+
  '<p>On approximately half of the STOP trials, the red stop signal will appear soon and you will notice that it will be easy to stop your response. </p>'+
